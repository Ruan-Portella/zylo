...
export const UserPageBanner = ({ user }: UserPageBannerProps) => {
  ...
  const [isBannerUploadModalOpen, setBannerUploadModalOpen] = useState(false);
  ...
  return (
    <div className="relative group">
      ...
      />
      <div className={cn(
        'w-full max-h-[200px] h-[15vh] md:h-[25vh] bg-gradient-to-tr from-gray-100 to-gray-200 rounded-xl',
